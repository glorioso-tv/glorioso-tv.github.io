...
def list_categories(_handle, _url, categories):
    xbmcplugin.setPluginCategory(_handle, 'Categorias')
    xbmcplugin.setContent(_handle, 'videos')

    for category in categories:
        list_item = xbmcgui.ListItem(label=category['title'])
        url = get_url(_url, action='category', link=category['link'], category=category['title'])
